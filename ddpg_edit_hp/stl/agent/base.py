...
from stl.utils import OrnsteinUhlenbeckActionNoise
import numpy as np
...
class BaseAgentParams:
    def __init__(self):
        ...
        self.add_actions_observations = False
        self.action_observations_dim = 4

        self.action_factor = 0.3


class BaseAgent:
    def __init__(self, params: BaseAgentParams, shape_observations=4, shape_targets=2, shape_action=2,
                 on_edge=False):
        self.params = params
