...
from stl.agent.base import BaseAgent, BaseAgentParams
...
class DDPGAgent(BaseAgent):
    ...
    def __init__(self, params: DDPGAgentParams, shape_observations=4, shape_targets=2, shape_action=2, on_edge=False):
