...
class QLearningTable:
    ...
    def plot_results(self, steps, cost,all_reward_sum):
        #
        ...
        #
        ave_reward = [a / b for a, b in zip(all_reward_sum, steps)]
        plt.figure()
        plt.plot(np.arange(len(ave_reward)), ave_reward, 'g')
        plt.title('Episode via ave_reward')
        plt.xlabel('Episode')
